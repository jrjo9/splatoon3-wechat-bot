 ...
 **/
@Slf4j
@WxMsgType(value = WxMsgConstant.LAST_MATCH, desc = "最近一场比赛")
@Component
public class NSOLastMatchWxMsgService extends PaipaiWxMsgStrategy {
    ...
    public void doBusiness(WechatMessage wechatMessage) throws Exception {
        ...
        try {
            ...
            content = nsoService.getLastMatch(wxid);
