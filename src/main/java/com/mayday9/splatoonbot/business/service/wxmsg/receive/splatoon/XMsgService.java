...
/**
 * @author Lianjiannan
 * @since 2024/10/12 11:20
 **/
@Slf4j
@WxMsgType(value = WxMsgConstant.X, desc = "X比赛")
@Component
public class XMsgService extends PaipaiWxMsgStrategy {
    ...
    public void doBusiness(WechatMessage wechatMessage) throws Exception {
        ...
        getMatchDailyInfoDTO.setMatchType(SplatoonConstant.MATCH_TYPE_X);
