 ...
 **/
@Slf4j
@WxMsgType(value = WxMsgConstant.LAST_SALMON_RUN, desc = "最近一场打工")
@Component
public class NSOLastSalmonRunWxMsgService extends PaipaiWxMsgStrategy {
    ...
    public void doBusiness(WechatMessage wechatMessage) throws Exception {
        ...
        try {
            ...
            content = nsoService.getLastCoop(wxid);
