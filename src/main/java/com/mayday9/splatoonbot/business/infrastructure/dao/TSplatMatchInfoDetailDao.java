 ...
 * @since 2024-09-29
 */
public interface TSplatMatchInfoDetailDao extends IBaseDao<TSplatMatchInfoDetail> {

    /**
    * 新增
    * @param tSplatMatchInfoDetail  新增参数
    * @return 成功或失败
    */
    boolean add(TSplatMatchInfoDetail tSplatMatchInfoDetail);
    /**
    * 编辑
    * @param tSplatMatchInfoDetail  编辑参数
    * @return 成功或失败
    */
    boolean edit(TSplatMatchInfoDetail tSplatMatchInfoDetail);
    /**
    * 批量删除
    * @param ids 主键ids
    * @return 成功或失败
    ...
    * @return 分页列表
    */
    PageResult<TSplatMatchInfoDetail> search(SearchDTO searchDTO);
    /**
    * 名称不重复
    * @param id 主键
    * @param name 名称
